                ...
                >
                     ...
                     <div className="bg-white flex-1 shadow-lg rounded-3xl p-6 md:p-10 border border-blue-200 flex flex-col justify-between">
                        <div
                            dir="rtl"
                            ref={ctaRef}
                            className="flex flex-col md:flex-row items-center gap-6 px-6 py-8 bg-white rounded-2xl shadow-md border"
                        >
                            <Link
                                to="https://wa.me/+201010195337"
                                target="_blank"
                                className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-bold shadow-md transition duration-300"
                            >
                                اطلب منتجاتنا
                            </Link>
