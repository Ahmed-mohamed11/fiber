...
export default function ContactForm() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center mt-20 p-4 font-sans bg-gradient-to-b from-white via-blue-50 to-white"
      dir="rtl">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div
          className="mt-10 flex flex-col md:flex-row justify-around items-center gap-6 text-center text-gray-700 text-base font-medium">
          <div className="flex items-center gap-2">
            <MdMailOutline className="text-sky-600 text-xl"/>
            <span>shoshagroup@gmail.com</span>
          </div>
          <div className="flex items-center gap-2">
